...
<img src="{{ '/assets/img/results.jpg' | relative_url }}" alt="Comparison of recall, precision, F1, and accuracy across the four ArKanjo detection methods, with the embedding-based method leading" style="max-width: 100%; height: auto; display: block; margin: 1rem auto; border-radius: 8px;">
