...
![Comparison of recall, precision, F1, and accuracy across the four ArKanjo detection methods, with the embedding-based method leading]({{ "/assets/img/results.jpg" | relative_url }})
